...
- Pull Requests verlinken das zugehoerige Issue. Wenn ein PR ein Ticket vollstaendig erledigt, wird das Issue ueber den PR oder nach dem Merge geschlossen und das Project Item auf `Done` gesetzt.
