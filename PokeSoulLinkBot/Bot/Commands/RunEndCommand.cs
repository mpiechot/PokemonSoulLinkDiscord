...
/// </summary>
public class RunEndCommand : ISlashCommand
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RunEndCommand"/> class.
    /// </summary>
    ...
    /// <inheritdoc />
    public string CommandName => "run-end";
    ...
    public ApplicationCommandProperties BuildDefinition()
    {
        return new SlashCommandBuilder()
            .WithName("run-end")
            .WithDescription("End the currently active Soul Link run.")
            .AddOption("reason", ApplicationCommandOptionType.String, "The reason for ending the run.", isRequired: false)
            .Build();
    }
    ...
    public async Task HandleAsync(SocketSlashCommand command)
    {
        ...
        var run = this.runService.EndRun(guildId, reason);
